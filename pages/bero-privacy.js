...
export default () => (
  <Layout>
    ...
    <p>
      ...
      Bill Searle at no cost and is intended for use as is.
    </p>
    <p>
    ...
    <p>
      ...
      accessible at Bero unless otherwise defined in this Privacy Policy.
    </p>
    <p><strong>Information Collection and Use</strong></p>
    <p>
      For a better experience, while using our Service, I may require you to provide us with certain
      personally identifiable information, including but not limited to location data. The information that I request will be
