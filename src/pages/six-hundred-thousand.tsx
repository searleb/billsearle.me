      ...
      <Layout>
        ...
        <article>
          ...
          <p>
            ...
            with a threshold of 4.5, which insures a usable level of 4.5:1 Aa
            contrast.
          </p>
          <p>
            What I was able generate was a list of 1937 Pantone colours with a
            total of{" "}
            {(six && six.totalCombinations.toLocaleString()) || "600000"} safe
            to use combinations.
          </p>
          <p>
            The resulting JSON file is too big to deliver and process on the
            front end so I&apos;ve built a small node endpoint that will return
            a random colour set on a GET.
          </p>
          <p className="mb-8">
            Below are a few components demoing how all these can actually be
            used.
          </p>
          ...
          <div className="flex flex-wrap justify-between flex-1">
            ...
            <div className="flex flex-wrap content-start sm:w-1/2">
              <div className="grid grid-cols-2">
                <ImagePill
                  theme={six.theme}
                  img="/six/trainwreck.jpg"
                  text="Macey Boyle"
                  invert
                />
                <ImagePill
                  theme={six.theme}
                  img="/six/iceland.jpeg"
                  text="Lambert Stracke"
                  invert
                  className="hidden sm:block"
                />
                <ImagePill
                  theme={six.theme}
                  img="/six/pemberton-flowers.jpeg"
                  text="Sabryna Luettgen"
                  className="hidden sm:block"
                />
                <ImagePill
                  theme={six.theme}
                  img="/six/skybridge.jpg"
                  text="Gianni Russel"
                />
              </div>
            </div>
            ...
            <Card theme={six.theme}>
              ...
              <div
                ...
                style={{ borderColor: six.theme.tertiary }}
              />
